...
<br>
            ...
            <div class="mt-4">
                <x-label for="email" value="{{ __('Number') }}" />
                <x-input id="number" class="block mt-1 w-full" type="text" name="number" :value="old('number')" required autocomplete="number" />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-button style="background-color:#70c745;" class="ml-4">
                    {{ __('Register') }}
                </x-button>
            </div>
        </form>
