                ...
                <div class="col-12 col-md-8">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-post mb-50">
                                <div class="post-thumbnail mb-30">
                                    <a href=""><img src="theme/img/bg-img/6.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-post mb-50">
                                <div class="post-thumbnail mb-30">
                                    <a href=""><img src="theme/img/bg-img/8.jpg" alt=""></a>
                                </div>
                                <div class="post-content">
                ...
                <div class="col-12 col-md-4">
                    <div class="post-sidebar-area">
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-latest-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <img src="theme/img/bg-img/30.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <img src="theme/img/bg-img/31.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <img src="theme/img/bg-img/32.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <img src="theme/img/bg-img/33.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-best-seller-product d-flex align-items-center">
                                <div class="product-thumbnail">
                                    <a href=""><img src="theme/img/bg-img/5.jpg" alt=""></a>
                                </div>
                                <div class="product-info">
                            ...
                            <div class="single-best-seller-product d-flex align-items-center">
                                <div class="product-thumbnail">
                                    <a href=""><img src="theme/img/bg-img/34.jpg" alt=""></a>
                                </div>
                                <div class="product-info">
